...
public class Bus : SimulatedSystem {
  ...
  public void PreTick(uint delta, CompositeSpacecraft vessel) {
  ...
  public void Tick(uint delta, CompositeSpacecraft vessel) {
    foreach (PowerConsumer consumer in this.consumers) {
  ...
  public void PostTick(uint delta, CompositeSpacecraft vessel) {}
